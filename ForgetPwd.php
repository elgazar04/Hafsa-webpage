...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/airtic.png">
        ...
        <div class="main-content container-fluid">
          <div class="splash-container forgot-password">
            <div class="card card-border-color card-border-color-success">
              <div class="card-header"><img class="logo-img" src="assets/img/airtic.png" alt="logo" width="102" height="#{conf.logoHeight}"><span class="splash-description">Forgot your password?</span></div>
              <div class="card-body">
            ...
            <div class="splash-footer">&copy; 2019 - <?php echo date ('Y');?> Online Flight Booking | Developed By Gazar & Mohamed Essam </div>
        </div>
      </div>
    </div>
